...
function Socials() {
    return (
        <div className="main-socials">
            ...
            <a className="bg-white p-2 ml-3 mr-3 rounded-lg active" href="https://www.linkedin.com/in/stevenselolo/"><span className="inline-block align-middle"><FaLinkedinIn/></span></a>
